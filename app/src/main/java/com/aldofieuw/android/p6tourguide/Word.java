...
public class Word {
     ...
     * @param locatioId is the string resource Id for the word in the Miwok language
     */
    public Word(int titleId, int locatioId) {
        mTitle = titleId;
        mLocation = locatioId;
    }
     ...
     */
    public Word(int titleId, int locationId, int imageResourceId,
                int audioResourceId) {
        mTitle = titleId;
